...
describe('App', () => {
  ...
  test('hotel is found with distance', () => {
    expect(app.findHotelNearbyWithBestOffer(48.856564, 2.351711, 2000, '11/01/2021').distance).toBeDefined();
  });
  test('hotel is found with distance less of 2000 meters', () => {
    expect(app.findHotelNearbyWithBestOffer(48.856564, 2.351711, 2000, '11/01/2021').distance).toBeLessThanOrEqual(2000);
  });
});
